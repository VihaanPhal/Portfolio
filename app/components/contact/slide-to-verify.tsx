    ...
    <div className={className}>
      ...
      >
        ...
        >
          ...
          {!isVerified && (
            <motion.div
              className="absolute top-[2px] left-[2px] w-12 h-12 rounded-full flex items-center justify-center cursor-grab active:cursor-grabbing z-10"
              style={{
                x,
                backgroundColor: "var(--primary)",
              }}
          ...
          {isVerified && (
            <motion.div
              className="absolute top-[2px] right-[2px] w-12 h-12 rounded-full flex items-center justify-center z-10"
              initial={{ scale: 0.8 }}
              animate={{ scale: 1 }}
